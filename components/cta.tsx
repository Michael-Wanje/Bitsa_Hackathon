      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="rounded-3xl p-12 sm:p-16 backdrop-blur-md bg-white/10 border border-white/20">
          ...
          <p className="text-lg text-muted-foreground mb-12 max-w-3xl mx-auto text-center leading-relaxed">
            Whether you're a beginner or an experienced developer, there's a place for you at <span className="inline-flex items-center"><img src="/bitsa_logo.jpg" alt="Logo" className="w-6 h-6 rounded-lg object-contain inline-block mr-1" /></span>. Connect with peers,
